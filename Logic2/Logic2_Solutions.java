...
public int helper(int n){
  if((n==13 || n==14) || (n >= 17 && n <= 18))
   return 0;
   else return n;
}

#roundSum
For this problem,  round an int value up to the 
...
repetition, write a separate helper "public int round10
(int num) {" and call it 3 times. Write the helper entirely below and at the same indent level as roundSum().
